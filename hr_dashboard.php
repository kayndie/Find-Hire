...
if (isset($_SESSION['user_id']) && $_SESSION['role'] == 'hr') {
    ...
    $applications = $application->getApplications($_SESSION['user_id']);
        ...
        <body>
            <div class="container">
                    ...
                    <ul>
                        <?php foreach ($jobPosts as $jobPost) { ?>
                            <li>
                                ...
                                <a href="view_applications.php?job_post_id=<?php echo $jobPost['id']; ?>">View Applications</a>
                            </li>
                        <?php } ?>
                    </ul>
                </div>
                ...
                <div class="button-group">
                    <a href="create_job_post.php" class="button">Create Job Post</a>
